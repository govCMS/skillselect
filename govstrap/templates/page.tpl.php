  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-md-6 text-right" id="logo">
        <a href="/"><img src="<?php print '/'.drupal_get_path('theme', 'govstrap').'/img/skillselect.png';?>" srcset="<?php print '/'.drupal_get_path('theme', 'govstrap').'/img/skillselect-hidpi.png';?> 2x" height="85" alt="Skillselect Home" /></a>
      </div>
    </div>
  </div>
</header><!-- /#page-header -->
