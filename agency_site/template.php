 ...
 */
function agency_site_preprocess_html(&$vars) {
 ...
 */
function agency_site_form_alter(&$form, &$form_state, $form_id) {
 ...
 */
function agency_site_preprocess_page(&$variables) {
}

/**
 * Implements hook_preprocess_region().
 */
function agency_site_preprocess_region(&$variables) {
 ...
 */
function agency_site_preprocess_maintenance_page(&$variables) {

  $t_function = get_t();

  if (drupal_installation_attempted()) {
    $variables['logo'] = base_path() . drupal_get_path('theme', 'agency_site') . '/logo.png';
 ...
 */
function agency_site_preprocess_node(&$variables) {
 ...
 */
function agency_site_process_node(&$variables) {
 ...
 */
function _agency_site_process_node_compact(&$variables) {
 ...
 *   Standard variables array
 */
function _agency_site_process_node_compact_teaser(&$variables) {
 ...
 */
function agency_site_status_messages($variables) {
 ...
 */
function agency_site_form_required_marker($variables) {
 ...
 */
function agency_site_preprocess_aria_invalid(&$variables) {
 ...
 */
function agency_site_theme_registry_alter(&$theme_registry) {
  ...
  foreach ($theme_functions as $hook) {
    $theme_registry[$hook]['preprocess functions'][] = 'agency_site_preprocess_aria_invalid';
  }
}
 ...
 * reverse proxies.
 */
function agency_site_file_link($variables) {
  $file = $variables ['file'];
